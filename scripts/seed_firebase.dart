...
Future<void> main() async {
  ...
  for (var r in restaurants) {
    await firestore.collection('restaurants').doc(r.id).set(r.toFirestore());
  ...
  for (var f in foodItems) {
    await firestore.collection('food_items').doc(f.id).set(f.toFirestore());
  ...
  for (var c in charities) {
    await firestore.collection('charities').doc(c.id).set(c.toFirestore());
